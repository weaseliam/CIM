...
public class GraveService
{
	...
	public ServiceListResponse<Grave> list(int page, int size, String sort, GraveFilter filter)
	{
		...
		ServiceListResponse<Grave> response = GraveAssembler.toServiceListResponse(graves, sort);
